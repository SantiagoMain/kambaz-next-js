...
import ScreenSizeLabel from "./tailwind/ScreenSizeLabel";
import BoostrapTable from "./BootstrapTables";
...
export default function Lab2() {
  return (
    <div id="wd-lab2">
      ...
      {/* Exercise 2.1.4 - Class Selectors */}
      ...
      {/* Exercise 2.1.5 - Document Structure */}
