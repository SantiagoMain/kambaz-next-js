...
export default function QueryParameters() {
    ...
    return (
        <div id="wd-query-parameters">
            ...
            <FormControl id="wd-query-parameter-a" className="mb-2"
                defaultValue={a} type="number"
                onChange={(e) => setA(e.target.value)} />
            <FormControl id="wd-query-parameter-b" className="mb-2"
            ...
            <a id="wd-query-parameter-divide" className="btn btn-success"
