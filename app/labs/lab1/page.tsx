export default function Lab1() {
  ...
  <p id="wd-p-1">
    ...
    spaces to make the text easier to read. Browsers ignore vertical white spaces and
    render all the text as one single set of sentences. To force the browser to add
    vertical spacing, wrap the paragraphs you want to separate with the paragraph tag
  </p>
  <p id="wd-p-2">
...
<a href="https://github.com/SantiagoMain/kambaz-next-js" id="wd-github">
